...
namespace Oblig1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var daniel = new Person { Id = 9, FirstName = "Daniel", LastName = "Antonsen", BirthYear = 1993 };
            var annmarie = new Person { Id = 10, FirstName = "Ann Marie", LastName = "Haugstuen", BirthYear = 1969 };
            ...
            haakon.Mother = sonja;
            harald.Father = olav;
            daniel.Mother = annmarie;

            var app = new FamilyApp(sverreMagnus, ingridAlexandra, haakon,
                metteMarit, marius, harald, sonja, olav, daniel, annmarie);
